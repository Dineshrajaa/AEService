			...
			if(comments.length){
				return Promise.map(comments.models,function(comment){
					...
					return  {
							...
							"ReviewCommentImage": config.image_url+comment.get('ReviewCommentImage'),
							...
							"UserImage": config.image_url+comment.relations.UserAccount.get('UserImage'),
			...
			if(reviews.length){
				return Promise.map(reviews.models,function(review){
					...
					return  {
						      ...
						      "Attachment": config.image_url+review.get("Attachment"),
						      "UserAccount": null,
						      "OrgImage": null,
						      "OrgName": null,
						      "address": review.relations.UserAccount.get("City")+', '+review.relations.UserAccount.get("Town"),
						      "UserImage": config.image_url+review.relations.UserAccount.get("UserImage"),
